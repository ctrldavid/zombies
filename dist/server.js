...
/***/ function(module, exports, __webpack_require__) {
	...
	var uuid = __webpack_require__(110);
	...
	*/
	...
	var PRIORITY = {
	  high: (0, _symbol2.default)(),
	  medium: (0, _symbol2.default)(),
	  low: (0, _symbol2.default)()
	};
	...
	var PrioritySender = function () {
	  function PrioritySender() {
	    ...
	    this.queues = new _map2.default((0, _values2.default)(PRIORITY).map(function (s) {
	      return [s, []];
	    }));
	  }

	  (0, _createClass3.default)(PrioritySender, [{
	    key: 'addSlice',
	    ...
	    value: function read(number) {
	      ...
	      var read = [];
	      var slice = void 0;
	      var queue = this.queues.get(PRIORITY.medium);
	      var now = Date.now();
	...
	var Connection = function Connection(ws) {
	    ...
	    value: function initWebsocket() {
	      ...
	      this.webSocketServer.on('connection', function (ws) {
	        ...
	        ws.on('message', function (message) {
	          ...
	          if (message.service && _this.services[message.service]) {
	            _this.services[message.service].incoming(connection, message);
	          } else {
	...
	var GameService = function (_Service) {
	  (0, _inherits3.default)(GameService, _Service);

	  function GameService() {
	    (0, _classCallCheck3.default)(this, GameService);

	    var _this2 = (0, _possibleConstructorReturn3.default)(this, (GameService.__proto__ || (0, _getPrototypeOf2.default)(GameService)).call(this));

	    _this2.serviceTag = "test";
	    _this2.games = ["game 1", "game 2", "game 3"];
	    return _this2;
	  }

	  (0, _createClass3.default)(GameService, [{
	    key: 'incoming',
	    value: function incoming(connection, message) {
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(13)(Function.call, __webpack_require__(45).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
